...
'''
okay so I think I'm on the right track here... but not certain maybe im just losing it lol
'''
...
gbc_pred_final = gbc.predict(X_test)

# Predicting on the last 270 unseen variables
predictions = gbc.predict(y2)

print('AUC:', metrics.roc_auc_score(y_test, gbc_pred_final))